...
<footer class="page-footer font-small unique-color-dark" style="background-color: black;color:white">
  ...
  <div style="background-color: #6351cc; height:100px;">
    <div class="container">
      ...
      <!-- Grid row-->
      <div class="row py-4 d-flex align-items-center" style="height:50px;">
        ...
        <div class="col-md-6 col-lg-7 text-center text-md-right">
          ...
          <!-- Twitter -->
          <a class="tw-ic mr-5 btn btn-lg" style="color:white" href="https://twitter.com/hashim_temam" target="_blank">
            <i class="fab fa-twitter fa-lg mr-4"> </i>
          </a>
          <!-- Google +-->
          <a class="gplus-ic mr-5 btn btn-lg" style="color:white" href="https://myaccount.google.com/" target="_blank">
  ...
  <div class="container text-center text-md-left mt-5">
    ...
    <div class="row mt-3">
      ...
      <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
        ...
        <p>
          <a href="index.php">Tax</a>
        </p>
        <p>
          <a href="contact.php">Food</a>
        </p>
        <p>
          <a href="#">Content</a>
        </p>
  ...
  <div class="footer-copyright text-center py-3 ">
    ...
    <a href="https://agro.tcoder.lovestoblog.com">By Temam</a>
  </div>
  <!-- Copyright -->
