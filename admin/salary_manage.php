        ...
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><a href="salary_invoice.php?invoice_id=<?php echo $row['sl_id'];?>"
                  class="btn btn-warning">Invoice</a></td>
              <td><a href="salary_edit.php?edit_id=<?php echo $row['sl_id'];?>" class="btn btn-info">Edit</a></td>
              <td><a href="salary_manage.php?delete_id=<?php echo $row['sl_id'];?>" class="btn btn-danger">Delete</a>
              </td>
            </tr>
            <?php } ?>
