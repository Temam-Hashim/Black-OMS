            ...
            <form action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="mobile" name="name"
                    value="<?php echo $row['st_mobile'] ?>">
                </div>
                <div class="form-group">
                  <label for="title"> Email</label>
                  <input type="text" class="form-control" name="email" name="name"
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="date" class="form-control" name="join_date" value="<?php echo $row['date_of_joining'] ?>"
                    required>
                </div>
