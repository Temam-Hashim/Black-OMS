                        ...
                        <form action="" method="POST" enctype="multipart/form-data" id="form">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="bank_name" value="<?php echo InputValue('bank_name'); ?>">
                                    </div>

                                    <div class="form-group">
                                        <label for="title"> Acount No</label>
                                        <input type="text" class="form-control" name="acount_no" value="<?php echo InputValue('acount_no'); ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="qualification" value="<?php echo InputValue('qualificatio'); ?>">
                                    </div>
                                </div>
                            <!-- right form  -->
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="join_date" value="<?php echo InputValue('join_date'); ?>">
                                    </div>
                                ...
                                <!-- address division -->
                                       ...
                                       <div class="form-group">
                                           <label for="title"> Address</label>
                                            <input type="text" class="form-control" name="city" placeholder="City" value="<?php echo InputValue('city'); ?>"><br>
                                            <input type="text" class="form-control" name="state" placeholder="State"  value="<?php echo InputValue('state'); ?>"><br>
                                            <input type="text" class="form-control" name="country" placeholder="Countyr"  value="<?php echo InputValue('country'); ?>"><br>
                                            <input type="text" class="form-control" name="pin" placeholder="Pin Code"  value="<?php echo InputValue('pin'); ?>"><br>
                                        </div>
