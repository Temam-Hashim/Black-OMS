                ...
                <div class="box-header text-center">
                  ...
                  <small class="pull-right">Date: <?php echo date('d-m-Y'); ?></small>
                    ...
                    <div class="row invoice-info">
                      ...
                      <!-- date -->
                      <div class="col-xs-4">
                        <strong>Invoice No #00<?php echo $row['py_id'];?></strong><br><hr>
            ...
            <div class="content no-print">
                  <div class="col-md-12">
                    <button onclick="PrintSection()" class="btn btn-default"><i class="fa fa-print"></i> Print</button>
                      <a href="payment_invoice.php?py_id=<?php echo $row['py_id'];?>" class="btn btn-success pull-right" name="submit_payment"><i class="fa fa-credit-card"></i> Submit Payment</a>
