...
<div class="col-xs-12">
    ...
    <form action="" method="GET" enctype="multipart/form-data">
      ...
      <div class="col-md-10">
        ...
        <div class="form-group">
            <label for="post_content">Password(This Password is always System Generated)</label>
            <input type="password" readonly class="form-control" name="password" value="<?php echo implode($pass) ?>">
        </div>
  ...
  <?php
     ...
     if(isset($_GET['add_user'])) {
        ...
        $body.= "<div color='red'><b>Disciplinary:</b><br><small>This is system generated email, do not replay to this email, contact the admin if you have any problem.</small></div>";
