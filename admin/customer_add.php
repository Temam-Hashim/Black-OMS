        ...
        <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <small>Kebale</small>
                <input type="text" class="form-control" name="kebale" value="<?php echo InputValue('kebale'); ?>" required>
              </div>
              ...
              <small>Sub City</small>
                ...
                <input type="text" class="form-control" name="houseno" value="<?php echo InputValue('houseno'); ?>" required>
              </div>

              <div class="col-md-4">
              <small>Werada</small>
                <input type="text" class="form-control" name="werada" value="<?php echo InputValue('werada'); ?>" required>
                <small>PIN Code</small>
                <input type="text" class="form-control" name="pincode" value="<?php echo InputValue('pincode'); ?>" required>
              </div>
...
<!-- identify exprience level -->
  ...
  <?php
     ...
     if(isset($_POST['add_customer'])) {
        ...
        $count = $res->num_rows;
        if($count==0){
          AddNewCustomer($fname,$mname,$lname,$email,$mobile,$gender,$dob,$age,$birth_place,$martial_status,$occupation,$nationality,$current_address,$permanent_address,$emergency_contact,$education_background,$education_level,$salary_range,$exp_level, $exp_year,$employment_type);  
